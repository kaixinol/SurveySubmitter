...
class DistributionHelperTests:
    ...
    def test_resolve_distribution_probabilities_returns_target_when_no_runtime_context(
        self, monkeypatch
    ) -> None:
        monkeypatch.setattr(
            distribution,
    ...
    def test_resolve_distribution_probabilities_applies_runtime_correction(
        self, monkeypatch
    ) -> None:
        monkeypatch.setattr(
            distribution,
    ...
    def test_resolve_distribution_probabilities_uses_priority_profile_when_dimension_or_plan_active(
        self, monkeypatch
    ) -> None:
        monkeypatch.setattr(
            distribution,
    ...
    def test_record_pending_distribution_choice_ignores_invalid_input_and_records_valid_choice(
        self,
    ) -> None:
        ctx = _FakeCtx()
