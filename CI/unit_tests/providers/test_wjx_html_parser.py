...
class WjxHtmlParserTests:
    ...
    def test_parse_survey_questions_from_html_extracts_basic_question_metadata(self) -> None:
        ...
        assert first["type_code"] == QuestionType.SINGLE
        ...
        assert second["type_code"] == QuestionType.MULTIPLE
    ...
    def test_parse_survey_questions_from_html_extracts_matrix_and_slider_metadata(self) -> None:
        ...
        slider = questions[1]
        assert slider["num"] == 4
        assert slider["type_code"] == QuestionType.SLIDER
    ...
    def test_parse_survey_questions_from_html_falls_back_to_nested_topic_divs_and_slider_matrix(
        ...
        assert location["type_code"] == QuestionType.LOCATION
        assert location["text_inputs"] == 0

        region = questions[1]
        assert region["is_location"]
        assert region["type_code"] == QuestionType.LOCATION
