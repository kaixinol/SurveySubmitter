...
class ProviderCommonTests:
    ...
    def test_build_grouped_runtime_items_filters_blank_dimension(self) -> None:
        ...
        with patch('survey_submitter.core.engine.provider_common.build_psychometric_blueprint', return_value={'A': [_FakeBlueprintItem({'num': 1})], '': [_FakeBlueprintItem({'num': 2})]}):
    ...
    def test_build_psychometric_plan_for_run_returns_none_when_blueprint_is_empty(self) -> None:
        with patch('survey_submitter.core.engine.provider_common._build_grouped_runtime_items', return_value={}):
    ...
    def test_build_psychometric_plan_for_run_falls_back_to_default_target_alpha_when_normalizer_errors(self) -> None:
        config = ExecutionConfig()
        with patch('survey_submitter.core.engine.provider_common._build_grouped_runtime_items', return_value={'A': [{'num': 1}]}), patch('survey_submitter.core.engine.provider_common.normalize_target_alpha', side_effect=[RuntimeError('boom'), 0.91]), patch('survey_submitter.core.engine.provider_common.build_dimension_psychometric_plan', return_value='plan') as build_mock:
    ...
    def test_ensure_joint_psychometric_answer_plan_reuses_cached_value(self) -> None:
        ...
        with patch('survey_submitter.core.engine.provider_common.build_joint_psychometric_answer_plan') as build_mock:
    ...
    def test_ensure_joint_psychometric_answer_plan_builds_and_caches_value(self) -> None:
        config = ExecutionConfig()
        with patch('survey_submitter.core.engine.provider_common.build_joint_psychometric_answer_plan', return_value='joint-plan') as build_mock:
            plan = ensure_joint_psychometric_answer_plan(config)
    ...
    def test_provider_run_context_combines_joint_sample_plan_with_fallback(self) -> None:
        ...
        with patch('survey_submitter.core.engine.provider_common.generate_persona', return_value={}), patch('survey_submitter.core.engine.provider_common.set_current_persona'), patch('survey_submitter.core.engine.provider_common._reset_answer_context'), patch('survey_submitter.core.engine.provider_common.reset_tendency'), patch('survey_submitter.core.engine.provider_common.reset_consistency_context'), patch('survey_submitter.core.engine.provider_common.build_psychometric_plan_for_run', return_value='fallback-plan'), patch('survey_submitter.core.engine.provider_common.ensure_joint_psychometric_answer_plan', return_value=joint_plan), patch('survey_submitter.core.engine.provider_common.CombinedPsychometricPlan', return_value=combined_result) as combined_mock, patch('survey_submitter.core.engine.provider_common.reset_persona'):
    ...
    def test_provider_run_context_logs_global_dimension_summary_for_fallback_plan(self) -> None:
        ...
        with patch('survey_submitter.core.engine.provider_common.generate_persona', return_value={}), patch('survey_submitter.core.engine.provider_common.set_current_persona'), patch('survey_submitter.core.engine.provider_common._reset_answer_context'), patch('survey_submitter.core.engine.provider_common.reset_tendency'), patch('survey_submitter.core.engine.provider_common.reset_consistency_context'), patch('survey_submitter.core.engine.provider_common.build_psychometric_plan_for_run', return_value=fallback_plan), patch('survey_submitter.core.engine.provider_common.ensure_joint_psychometric_answer_plan', return_value=None), patch('survey_submitter.core.engine.provider_common.logging.info') as info_mock, patch('survey_submitter.core.engine.provider_common.reset_persona'):
